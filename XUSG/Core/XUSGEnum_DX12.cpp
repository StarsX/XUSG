...
D3D12_COMMAND_QUEUE_FLAGS XUSG::GetDX12CommandQueueFlags(CommandQueueFlag commandQueueFlags)
{
	...
	flags |= APPEND_COMMAND_QUEUE_FLAG(commandQueueFlags, ALLOW_DYNAMIC_PRIORITY);
...
D3D12_HEAP_FLAGS XUSG::GetDX12HeapFlags(MemoryFlag memoryFlags)
{
	...
	flags |= APPEND_HEAP_FLAG(memoryFlags, TOOLS_USE_MANUAL_WRITE_TRACKING);
...
{
	const auto D3D12_BARRIER_LAYOUT_VIDEO_QUEUE_COMMON = D3D12_BARRIER_LAYOUT(D3D12_BARRIER_LAYOUT_COMPUTE_QUEUE_COPY_DEST + 1);
