...
#define FROM_DX12_RESOURCE_DIMENSION(resDim) case D3D12_RESOURCE_DIMENSION_##resDim: return ResourceDimension::resDim
...
Format XUSG::GetFormatFromDXGI(DXGI_FORMAT format)
{
	switch (format)
	{
...
D3D12_COMMAND_LIST_TYPE XUSG::GetDX12CommandListType(CommandListType commandListType)
{
	static const D3D12_COMMAND_LIST_TYPE commandListTypes[] =
	{
		...
		D3D12_COMMAND_LIST_TYPE(4),	// D3D12_COMMAND_LIST_TYPE_VIDEO_DECODE,
		D3D12_COMMAND_LIST_TYPE(5),	// D3D12_COMMAND_LIST_TYPE_VIDEO_PROCESS,
		D3D12_COMMAND_LIST_TYPE(6)	// D3D12_COMMAND_LIST_TYPE_VIDEO_ENCODE
	};
...
ResourceDimension XUSG::GetResourceDimensionFromDX12(uint32_t resourceDimension)
{
	switch (resourceDimension)
	{
		FROM_DX12_RESOURCE_DIMENSION(BUFFER);
		FROM_DX12_RESOURCE_DIMENSION(TEXTURE1D);
		FROM_DX12_RESOURCE_DIMENSION(TEXTURE2D);
		FROM_DX12_RESOURCE_DIMENSION(TEXTURE3D);
...
D3D12_RESOURCE_STATES XUSG::GetDX12ResourceState(ResourceState resourceState)
{
	static const D3D12_RESOURCE_STATES resourceStates[] =
	{
		...
		D3D12_RESOURCE_STATES(0x400000),	// D3D12_RESOURCE_STATE_RAYTRACING_ACCELERATION_STRUCTURE,
		D3D12_RESOURCE_STATES(0x1000000),	// D3D12_RESOURCE_STATE_SHADING_RATE_SOURCE,
		D3D12_RESOURCE_STATES(0x10000),		// D3D12_RESOURCE_STATE_VIDEO_DECODE_READ,
		D3D12_RESOURCE_STATES(0x20000),		// D3D12_RESOURCE_STATE_VIDEO_DECODE_WRITE,
		D3D12_RESOURCE_STATES(0x40000),		// D3D12_RESOURCE_STATE_VIDEO_PROCESS_READ,
		D3D12_RESOURCE_STATES(0x80000),		// D3D12_RESOURCE_STATE_VIDEO_PROCESS_WRITE,
		D3D12_RESOURCE_STATES(0x200000),	// D3D12_RESOURCE_STATE_VIDEO_ENCODE_READ,
		D3D12_RESOURCE_STATES(0x800000)		// D3D12_RESOURCE_STATE_VIDEO_ENCODE_WRITE
	};
