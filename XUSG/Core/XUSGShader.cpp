...
void ShaderPool_DX12::SetShader(Shader::Stage stage, uint32_t index, const Blob& shader, const ReflectorPtr& reflector)
{
	SetShader(stage, index, shader);
	SetReflector(stage, index, reflector);
}

void ShaderPool_DX12::SetReflector(Shader::Stage stage, uint32_t index, const ReflectorPtr& reflector)
{
...
ReflectorPtr ShaderPool_DX12::GetReflector(Shader::Stage stage, uint32_t index) const
{
...
ReflectorPtr& ShaderPool_DX12::checkReflectorStorage(Shader::Stage stage, uint32_t index)
{
