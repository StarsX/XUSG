...
void ShaderPool_DX12::SetShader(Shader::Stage stage, uint32_t index, const Blob& shader, const Reflector_sptr& reflector)
{
	SetShader(stage, index, shader);
	SetReflector(stage, index, reflector);
}

void ShaderPool_DX12::SetReflector(Shader::Stage stage, uint32_t index, const Reflector_sptr& reflector)
{
...
Reflector_sptr ShaderPool_DX12::GetReflector(Shader::Stage stage, uint32_t index) const
{
...
Reflector_sptr& ShaderPool_DX12::checkReflectorStorage(Shader::Stage stage, uint32_t index)
{
