...
namespace FallbackLayer
{
    ...
    private:
        ...
        Microsoft::WRL::ComPtr<ID3D12PipelineState> m_pCalculateSceneAABBFromPrimitives;
        Microsoft::WRL::ComPtr<ID3D12PipelineState> m_pCalculateSceneAABBFromBVHs;
        Microsoft::WRL::ComPtr<ID3D12PipelineState> m_pCalculateSceneAABBFromAABBs;
    };
}
