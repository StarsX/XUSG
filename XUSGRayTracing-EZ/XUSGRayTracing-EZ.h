	...
	namespace RayTracing
	{
		namespace EZ
		{
			...
			public:
				...
				virtual void SetTriangleGeometries(GeometryBuffer& geometries, uint32_t numGeometries,
					Format vertexFormat, VertexBuffer* pVBs, IndexBuffer* pIBs = nullptr,
				...
				virtual void SetAABBGeometries(GeometryBuffer& geometries, uint32_t numGeometries,
					VertexBuffer* pVBs, const GeometryFlag* pGeometryFlags = nullptr) = 0;
